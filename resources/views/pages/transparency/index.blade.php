...
<div class="home-root" style="font-family: 'DM Sans', sans-serif;">
    <section class="hero min-h-[70svh]">
        <div class="hero-bar"></div>
        <div class="hero-glow"></div>
        <div class="hero-wm" style="font-family: 'Cormorant Garamond', serif;">REPORTS</div>
        ...
        <div class="hero-inner !grid-cols-1 !text-center">
            <div class="fu d1">
                ...
                <h1 class="hero-title" style="font-family: 'Cormorant Garamond', serif;">
                    Service Response <span class="gold-line" style="font-family: 'Cormorant Garamond', serif; font-style: italic;">& Resolution</span>
                </h1>

                <div class="hero-divider mx-auto"></div>

                <p class="hero-desc mx-auto !text-[#ffffff]/80">
                    In line with our commitment to a <span class="text-white font-bold">Smarter Daet</span>, this board tracks the real-time status of community infrastructure reports. We monitor the resolution of issues—from <span class="text-[var(--gold)]">uncollected garbage to broken streetlights</span>—ensuring LGU accountability.
                </p>

                {{-- Status Indicator with Top-to-Bottom Hover --}}
                <div class="group relative inline-flex items-center gap-4 px-6 py-4 bg-[#12294d] border border-[var(--border-gold)] rounded-sm shadow-xl transition-all duration-300 fu d3">

                    <div class="relative flex h-3 w-3">
                        <span class="animate-ping absolute inline-flex h-full w-full rounded-full bg-[#3FCB6F] opacity-75"></span>
                        <span class="relative inline-flex rounded-full h-3 w-3 bg-[#3FCB6F]"></span>
                    </div>
                    <span class="text-white/90 font-bold tracking-[0.1em] uppercase text-xs">Synchronizing Live LGU Response Data</span>
                </div>
            </div>
        </div>
    </section>
    ...
    <footer class="home-footer" style="font-family: 'DM Sans', sans-serif;">
        <p>© 2026 <strong>LGU Daet</strong> · Public Service Management System</p>
        <div class="footer-seal">Transparency & Accountability · RA 6713 Compliant</div>
    </footer>
</div>
