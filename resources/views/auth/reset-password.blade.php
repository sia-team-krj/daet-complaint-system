...
@section('title', 'Set New Password — Daet Listens')
@section('content')
  ...
  <div class="auth-layout auth-layout-centered">
    <div class="auth-form-panel">
      <div class="auth-form-wrap">
        ...
        <div class="auth-form-eyebrow fu d1">New Password</div>
        <h1 class="auth-form-heading fu d2">Set New Password</h1>
        <p class="auth-form-sub fu d2">
          Create a strong password for your account. Your new password must be at least 8 characters long.
        </p>
        ...
        <form method="POST" action="{{ route('password.update') }}">
          ...
          <div class="field-group fu d3">
            ...
            <div class="field-wrap">
              ...
              <input id="email" name="email" type="email" class="field-input" value="{{ old('email', $email ?? '') }}" required readonly>
          ...
          <div class="field-group fu d3">
            ...
            <div class="field-wrap">
              ...
              <input id="password" name="password" type="password" class="field-input" placeholder="••••••••" required autocomplete="new-password">
              <div class="field-underline"></div>
            </div>
          </div>
          ...
          <div class="field-group fu d4">
            ...
            <div class="field-wrap">
              ...
              <input id="password_confirmation" name="password_confirmation" type="password" class="field-input" placeholder="••••••••" required autocomplete="new-password">
              <div class="field-underline"></div>
            </div>
          </div>
